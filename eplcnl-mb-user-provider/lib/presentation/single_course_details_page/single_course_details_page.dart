import 'models/single_course_details_model.dart';
import 'package:eplcnl/core/app_export.dart';
import 'package:eplcnl/widgets/custom_elevated_button.dart';
import 'package:flutter/material.dart';
import 'package:readmore/readmore.dart';
import 'provider/single_course_details_provider.dart';

class SingleCourseDetailsPage extends StatefulWidget {
  const SingleCourseDetailsPage({Key? key}) : super(key: key);

  @override
  SingleCourseDetailsPageState createState() => SingleCourseDetailsPageState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SingleCourseDetailsProvider(),
        child: SingleCourseDetailsPage());
  }
}

class SingleCourseDetailsPageState extends State<SingleCourseDetailsPage>
    with AutomaticKeepAliveClientMixin<SingleCourseDetailsPage> {
  @override
                          ...
                          children: [
                            ...
                            Padding(
                                ...
                                child: Row(children: [
                                  ...
                                  Padding(
                                      padding:
                                          EdgeInsets.only(left: 17.h, top: 2.v),
                                      child: Text("lbl_25_lessons".tr,
