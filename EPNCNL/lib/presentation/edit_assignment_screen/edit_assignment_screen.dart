...
class EditDoingAssignmnetScreen extends StatefulWidget {
  final String assignmentID;
  final Duration cooldownTime;
  final bool isOnlineClass;

  const EditDoingAssignmnetScreen(
      {Key? key,
  ...
  @override
  State<EditDoingAssignmnetScreen> createState() => _EditDoingAssignmnetScreenState();
}

class _EditDoingAssignmnetScreenState extends State<EditDoingAssignmnetScreen> {
  ...
  void _startCooldownTimer() {
    ...
    _timer = Timer.periodic(Duration(seconds: 1), (timer) {
      ...
      if (_remainingSeconds <= 0) {
        ...
        Network.updateAssignmentAttempt(
          attemptId: (moduleUndoAssignmentAttempt[widget.assignmentID]?.first.id).toString(),
          answerText: additionalInfoController.text.toString(), assignmentId: widget.assignmentID, answerAudioUrl: _image,
        );
        _timer?.cancel();
        _timer = null;
      }
