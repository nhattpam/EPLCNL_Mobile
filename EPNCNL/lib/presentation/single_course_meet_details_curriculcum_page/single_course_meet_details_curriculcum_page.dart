...
class SingleCourseMeetDetailsCurriculcumPageState
  ...
  late List<ClassModules> listModule = [];
  @override
  ...
  Future<void> loadCourseByCourseID() async {
    try {
      final course = await Network.getClassModuleByCourseID(widget.courseID);
      setState(() {
        listModule = course;
      });
    } catch (e) {
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context,index){
                        final classModule = listModule[index];
                        return Row(
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(classModule.course?.category?.name ?? ""
                        ),
                                    Row(
                                      children: [
                                        ElevatedButton(
