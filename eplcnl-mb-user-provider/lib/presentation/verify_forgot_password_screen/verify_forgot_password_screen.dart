...
import 'models/verify_forgot_password_model.dart';
...
import 'provider/verify_forgot_password_provider.dart';
...
class VerifyForgotPasswordScreen extends StatefulWidget {
  ...
  @override
  VerifyForgotPasswordScreenState createState() =>
      VerifyForgotPasswordScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => VerifyForgotPasswordProvider(),
      child: VerifyForgotPasswordScreen(),
    );
  }
}

class VerifyForgotPasswordScreenState extends State<VerifyForgotPasswordScreen> {
  ...
  //             Selector<VerifyForgotPasswordProvider, TextEditingController?>(
  //               selector: (
  //                 context,
  //                 provider,
  //               ) =>
